          ...
          {activeTab === 'about' && (
            <>
              ...
              <div className="rounded-xl bg-slate-50 dark:bg-slate-800/30 p-3 text-[11px] text-slate-500 dark:text-slate-400 space-y-1">
                <div><strong>Application:</strong> NOVA AI</div>
                <div><strong>Version:</strong> 1.0.0 Minimal & Premium</div>
                <div><strong>Languages:</strong> Urdu (ur-PK), English (en-US), Punjabi (pa-PK)</div>
                <div><strong>Architecture:</strong> Full-Stack AI Assistant with Hybrid Voice & Multimodal Vision</div>
              </div>
            </>
          )}
        </div>
