...
export const CVCardExporter: React.FC<CVCardExporterProps> = ({
      ...
      <body>
        <div class="cv-container">
          ...
          <div class="footer-note">
            Generated with NOVA AI • Professional CV Builder
          </div>
        </div>
        <script>
  ...
  const handleExportImage = async () => {
    ...
    try {
      ...
      ctx.fillText('NOVA AI • PROFESSIONAL CV', padding, 45);
      ...
      ctx.fillText('Created with NOVA AI • Professional Multimodal Career Suite', padding, height - 35);
